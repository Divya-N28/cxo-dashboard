...
export default function Dashboard() {
  ...
  // Fetch data using generateMonthlyData from dataFetcher
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#f7f9fc]"> {/* Clean background like in first image */}
      ...
      <div className="p-6 max-w-[1920px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <Card className="p-4 bg-white shadow-sm rounded-lg">
            ...
            <p className="text-2xl font-semibold text-gray-900 mt-2">{currentMonthData?.totalApplicants}</p>
          </Card>

          <Card className="p-4 bg-white shadow-sm rounded-lg">
            <h3 className="text-sm font-medium text-gray-500">Offers Made</h3>
            <p className="text-2xl font-semibold text-gray-900 mt-2">{currentMonthData?.totalOffers}</p>
          </Card>
